    ...
    def open_config_window(self):
        ...
        try:
            ...
            predefined_function_pins = {
                ...
                # When selected, all three gear pins are configured together
                "Nav Light Toggle": str(LEFT_NAV_PIN),
                # When selected, all three nav light pins are configured together
            ...
            pin_dropdown = ttk.Combobox(self.config_window, textvariable=pin_var, values=available_pins,
                                        state="readonly")
